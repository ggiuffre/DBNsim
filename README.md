# ![lab logo](docs/img/CCNL.ico "Computational Cognitive Neuroscience Lab") DBNsim [![Build Status](https://travis-ci.org/ggiuffre/DBNsim.svg?branch=master)](https://travis-ci.org/ggiuffre/DBNsim)
